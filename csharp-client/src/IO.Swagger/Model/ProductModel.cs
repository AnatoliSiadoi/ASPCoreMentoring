...
namespace IO.Swagger.Model
{
    ...
    public partial class ProductModel :  IEquatable<ProductModel>, IValidatableObject
    {
        ...
        public ProductModel(string productName = default(string), string quantityPerUnit = default(string), double? unitPrice = default(double?), int? unitsInStock = default(int?), int? unitsOnOrder = default(int?), int? reorderLevel = default(int?), bool? discontinued = default(bool?), int? categoryId = default(int?), int? supplierId = default(int?))
        {
            // to ensure "productName" is required (not null)
            if (productName == null)
            {
                throw new InvalidDataException("productName is a required property for ProductModel and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("discontinued is a required property for ProductModel and cannot be null");
            }
            else
            {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ProductName, length must be less than 25.", new [] { "ProductName" });
            }
            ...
            if(this.QuantityPerUnit != null && this.QuantityPerUnit.Length > 25)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for QuantityPerUnit, length must be less than 25.", new [] { "QuantityPerUnit" });
            }

            // QuantityPerUnit (string) minLength
            if(this.QuantityPerUnit != null && this.QuantityPerUnit.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for QuantityPerUnit, length must be greater than 0.", new [] { "QuantityPerUnit" });
            }

            // UnitPrice (double?) maximum
            if(this.UnitPrice > (double?)100000)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for UnitPrice, must be a value less than or equal to 100000.", new [] { "UnitPrice" });
            }

            // UnitPrice (double?) minimum
            if(this.UnitPrice < (double?)0)
            {
            ...
            // UnitsInStock (int?) maximum
            if(this.UnitsInStock > (int?)32767)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for UnitsInStock, must be a value less than or equal to 32767.", new [] { "UnitsInStock" });
            }

            // UnitsInStock (int?) minimum
            if(this.UnitsInStock < (int?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for UnitsInStock, must be a value greater than or equal to 0.", new [] { "UnitsInStock" });
            }
            ...
            if(this.UnitsOnOrder < (int?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for UnitsOnOrder, must be a value greater than or equal to 0.", new [] { "UnitsOnOrder" });
            }

            // ReorderLevel (int?) maximum
            if(this.ReorderLevel > (int?)32767)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ReorderLevel, must be a value less than or equal to 32767.", new [] { "ReorderLevel" });
            }
